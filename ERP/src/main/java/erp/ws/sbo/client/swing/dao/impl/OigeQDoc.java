...
public class OigeQDoc implements IQDoc{
	...
	public void doclist(ParaList plist,QueryWindowView<?> v) {
		...
		SimpleDateFormat f=new SimpleDateFormat("yyyy-MM-dd");
 		...
 		hql="select distinct 0,type='生产发货',p.docNum,p.docDate,'','',p.usersign,q.u_name ,"+
           " '', ''," +
           "''," +
           "'' " + 		         
           " from Oige p " +
           " inner join ousr q on q.userid=p.usersign " +
           " inner join ige1 b on p.docentry=b.docentry and b.basetype='202'" +
           " where 1=1 ";
