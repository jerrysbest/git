...
public  class QrDocLineModel extends AbstractDocLineModel<QrColDocLine,DocLine<URm1Id>>{
...
/**
	 * 
	 */
public QrDocLineModel(QrColDocLine colob, DocLine<URm1Id> ob, DbUtils<QrColDocLine, DocLine<URm1Id>> dbu,
...
public QrDocLineModel(QrColDocLine colob, DocLine<URm1Id> ob, DbUtils<QrColDocLine, DocLine<URm1Id>> dbu,
    ...
    */
    ...
    public  boolean isCellEditable(int row,int col)
    {
    	...
    	if(col==this.getcolumnindex("序号")||col==this.getcolumnindex("销售单位"))
    	{   		
    		return false;
    	}
    	else
	...
	public boolean verification() {
		...
		for(int i=0;i<getRowCount();i++)
		{
		    ...
		    else if(this.getValuethrheader(i,"物料代码")!=null&&this.getValuethrheader(i,"物料代码").toString().substring(0, 2).equals("TD"))
		    {
		    	 ck=dataSet[i][this.getcolumnindex("仓库代码")].toString();
		    	 if(!ck.equals("2109"))
				 {
