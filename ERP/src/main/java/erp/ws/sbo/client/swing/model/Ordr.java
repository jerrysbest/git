...
public class Ordr implements java.io.Serializable {
	...
	/** minimal constructor */
	public Ordr(Integer docEntry, Integer docNum, Short instance,
			Short segment, String pindicator, String docSubType) {
	...
	/** full constructor */
	public Ordr(Integer docEntry, Integer docNum, String docType,
