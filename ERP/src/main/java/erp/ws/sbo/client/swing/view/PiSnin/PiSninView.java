package erp.ws.sbo.client.swing.view.PiSnin;
...
import erp.ws.sbo.client.swing.controller.PiSninsController;
...
public class PiSninView extends JInternalFrame{
    ...
    String[] ps={"0","1","2","3","4"};
    JComboBox com_pweight=new JComboBox(ps);
    ...
    Object[] obj;
    JLabel lab_ifseal = new JLabel("是否封箱");
    JComboBox com_ifseal = new JComboBox();
    JTextField  editor;
    ...
    public PiSninView()
	{
		...
		lay7.putConstraint(SpringLayout.WEST, lab_ifseal, 2, SpringLayout.EAST, bt_print);
		lay7.putConstraint(SpringLayout.SOUTH, lab_ifseal, 0, SpringLayout.SOUTH, lab_wareh);
		lay7.putConstraint(SpringLayout.WEST, lab_wareh, 2, SpringLayout.EAST, com_ifseal);
		lay7.putConstraint(SpringLayout.WEST, com_ifseal, 0, SpringLayout.EAST, lab_ifseal);
		lay7.putConstraint(SpringLayout.EAST, bt_selcode, 0, SpringLayout.EAST, bt_createcode);
		lay7.putConstraint(SpringLayout.WEST, lab_ifincomed, 6, SpringLayout.EAST, com_pweight);
		...
		lay7.putConstraint(SpringLayout.NORTH, com_ifseal, -3, SpringLayout.NORTH, lab_Qinspector);
	...
	private void initComponents() {
		 ...
		 lay7.putConstraint(SpringLayout.SOUTH, com_whsin, 0, SpringLayout.SOUTH, com_ifseal);
		 ...
		 com_pweight.setPrototypeDisplayValue("xxxxxxxx");
		 com_ifincomed.setPrototypeDisplayValue("xxx");		
		 com_ifincomed.addItem("否");
		 com_ifincomed.addItem("是");
		 com_ifseal.setPrototypeDisplayValue("xxx");		
		 com_ifseal.addItem("否");
		 com_ifseal.addItem("是");
		 ...
		 this.com_pweight.setEditable(true);
		 this.com_pweight.setEnabled(true);
		 this.com_pweight.setSelectedItem("0");
		 ...
		 lay7.putConstraint(SpringLayout.EAST, com_company, 0, SpringLayout.EAST, com_pweight);
		...
		lay7.putConstraint(SpringLayout.NORTH, com_pweight, -3, SpringLayout.NORTH, lab_specification);
		lay7.putConstraint(SpringLayout.WEST, com_pweight, 25, SpringLayout.EAST, lab_pweight);
		...
		jt.HiddenCell(od.getcolumnindex("计划数量"),0);
		jt.HiddenCell(od.getcolumnindex("完成数量"),0);
		...
		pane7.add(lab_ifseal);
		
		pane7.add(com_ifseal);
        ...
        pane4.add(scp);       
		 ...
		 //添加事件
		 editor = (JTextField) this.com_pweight.getEditor().getEditorComponent();
	     ...
	     editor.addKeyListener(oc);
	     this.txt_length.addKeyListener(oc);
	     getCom_pweight().addActionListener(oc);
	...
	public PiSninsController getOc() {
		return oc;
	}
	public void setOc(PiSninsController oc) {
		this.oc = oc;
	}
	...
	public JComboBox getCom_pweight() {
		return com_pweight;
	}

	public void setCom_pweight(JComboBox com_pweight) {
		this.com_pweight = com_pweight;
	}
	...
	public JComboBox getCom_ifseal() {
		return com_ifseal;
	}

	public void setCom_ifseal(JComboBox com_ifseal) {
		this.com_ifseal = com_ifseal;
	}
