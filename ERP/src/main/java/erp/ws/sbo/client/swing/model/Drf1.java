...
/**
 * Drf1 entity. @author MyEclipse Persistence Tools
 */

public class Drf1 implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4297853082425215416L;
	private Drf1Id id;
	...
	/** minimal constructor */
	public Drf1(Drf1Id id) {
		this.id = id;
	}

	/** full constructor */
	public Drf1(Drf1Id id, Integer targetType, Integer trgetEntry,
