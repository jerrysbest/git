...
public  class DesnDocLineModel extends AbstractDocLineModel<ColSNDocLine,SNDocLine>{
...
/**
	 * 
	 */
public DesnDocLineModel(ColSNDocLine colob, SNDocLine ob, DbUtils<ColSNDocLine, SNDocLine> dbu,
...
public DesnDocLineModel(ColSNDocLine colob, SNDocLine ob, DbUtils<ColSNDocLine, SNDocLine> dbu,
    ...
    */
    ...
    public  boolean isCellEditable(int row,int col)
    {
    	...
    	else if(ds==docLineStatus.remend)
    	{
    		if(col==this.getcolumnindex("所属大序列号"))
	    	{  		
	    		return true;
	    	}   
    		else{
    	...
    	{
    		if(col==this.getcolumnindex("序列号")||col==this.getcolumnindex("备注"))
	    	{  		
	    		return true;
	    	}   
    		else{
