...
public class OrinView extends JInternalFrame{
    ...
    JLabel lab_sales1 = new JLabel("销售员");
    ...
    public OrinView()
    {
    	super("应收贷向凭证",true,true,true,true);	
    ...
    {	
		...
		// txt_date.setLocale(Locale.US);//设置显示语言
		 ...
		 com_type.addItem( new  ComboBoxItem(0,"正常退货"));
		 com_type.addItem( new  ComboBoxItem(1,"其它退货(没有前置单据)"));			
		 com_type.addItem( new  ComboBoxItem(2,"换货(加工)"));
		 ...
		 txt_ter.setEditable(false);
		  ...
		  //单身主数据		   
			...
			//绑定伙伴代码
			 ...
			 od.setUpSportColumn(jt, jt.getColumnModel().getColumn(od.getcolumnindex("伙伴代码")),hql,hql1);
			//绑定物料编码
			...
			jt.getColumnModel().getColumn(od.getcolumnindex("伙伴代码")).setPreferredWidth(200);
