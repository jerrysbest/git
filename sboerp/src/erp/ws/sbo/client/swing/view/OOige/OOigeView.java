package erp.ws.sbo.client.swing.view.OOige;
...
import erp.ws.sbo.client.swing.controller.OOigesController;
...
import erp.ws.sbo.client.swing.tablemodel.OOigeDocTitleModel;
...
public class OOigeView extends JInternalFrame{

	/**
	 * 
	 */
	private static final long serialVersionUID = -5386813674444011307L;
	private OOigesController oc=new OOigesController(this);
    ...
    private OOigeDocTitleModel od1;
    ...
    public OOigeView()
	{
		super("其它出库",true,true,true,true);	
		initComponents();
	...
	private void initComponents() {
		...
		//单身主数据			   
		 ...
		 jt=new JMyTable(od,od.getcolumnindex("物料代码"),"OUTSN");
         ...
         hql="select '','','','','','','','','','','',''" +	         
     	           " from Ordr where 1=2 ";   
        od1 = new OOigeDocTitleModel(ct,dt,dbu1,hql,true);
	...
	public OOigesController getOc() {
		return oc;
	}
	public void setOc(OOigesController oc) {
		this.oc = oc;
	}
	...
	public OOigeDocTitleModel getOd1() {
		return od1;
	}

	public void setOd1(OOigeDocTitleModel od1) {
		this.od1 = od1;
	}
