...
public class QrColDocTitle {
	...
	private static QrColDocTitle CTitle;
	
	private QrColDocTitle()
	{
		
	}
	
	public static QrColDocTitle getCTitle()
	{  
		if(CTitle==null)
	   {
		CTitle=new QrColDocTitle();
	   }
		return CTitle;
	}
	...
	public static void setCTitle(QrColDocTitle cTitle) {
		CTitle = cTitle;
	}
