...
/**
 * Inv1 entity. @author MyEclipse Persistence Tools
 */

public class Inv1  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6151164957556934550L;
	private Inv1Id id;
	...
	/** minimal constructor */
    public Inv1(Inv1Id id) {
        this.id = id;
    }
    
    /** full constructor */
    public Inv1(Inv1Id id, Integer targetType, Integer trgetEntry, String baseRef, Integer baseType, Integer baseEntry, Integer baseLine, String lineStatus, String itemCode, String dscription, Double quantity, Timestamp shipDate, Double openQty, Double price, String currency, Double rate, Double discPrcnt, Double lineTotal, Double totalFrgn, Double openSum, Double openSumFc, String vendorNum, String serialNum, String whsCode, Short slpCode, Double commission, String treeType, String acctCode, String taxStatus, Double grossBuyPr, Double priceBefDi, Timestamp docDate, Integer flags, Double openCreQty, String useBaseUn, String subCatNum, String baseCard, Double totalSumSy, Double openSumSys, String invntSttus, String ocrCode, String project, String codeBars, Double vatPrcnt, String vatGroup, Double priceAfVat, Double height1, Short hght1unit, Double height2, Short hght2unit, Double width1, Short wdth1unit, Double width2, Short wdth2unit, Double length1, Short len1unit, Double length2, Short len2unit, Double volume, Short volUnit, Double weight1, Short wght1unit, Double weight2, Short wght2unit, Double factor1, Double factor2, Double factor3, Double factor4, Double packQty, String updInvntry, Integer baseDocNum, String baseAtCard, String sww, Double vatSum, Double vatSumFrgn, Double vatSumSy, Integer finncPriod, String objType, Short logInstanc, String blockNum, String importLog, Double dedVatSum, Double dedVatSumF, Double dedVatSumS, String isAqcuistn, Double distribSum, Double dstrbSumFc, Double dstrbSumSc, Double grssProfit, Double grssProfSc, Double grssProfFc, Integer visOrder, Double inmprice, Integer poTrgNum, String poTrgEntry, String dropShip, Integer poLineNum, String address, String taxCode, String taxType, String origItem, String backOrdr, String freeTxt, String pickStatus, Double pickOty, Integer pickIdNo, Short trnsCode, Double vatAppld, Double vatAppldFc, Double vatAppldSc, Double baseQty, Double baseOpnQty, Double vatDscntPr, String wtLiable, String deferrTax, Double equVatPer, Double equVatSum, Double equVatSumF, Double equVatSumS, Double lineVat, Double lineVatlF, Double lineVatS, String unitMsr, Double numPerMsr, String ceecflag, Double toStock, Double toDiff, Double exciseAmt, Double taxPerUnit, Double totInclTax, String countryOrg, Double stckDstSum, Double releasQtty, String lineType, String tranType, String text, Integer ownerCode, Double stockPrice, String consumeFct, Double lstByDsSum, Double stckInmpr, Double lstBinmpr, Double stckDstFc, Double stckDstSc, Double lstByDsFc, Double lstByDsSc, Double stockSum, Double stockSumFc, Double stockSumSc, Double stckSumApp, Double stckAppFc, Double stckAppSc, String shipToCode, String shipToDesc, Double stckAppD, Double stckAppDfc, Double stckAppDsc, String basePrice, Double gtotal, Double gtotalFc, Double gtotalSc, String distribExp, String descOw, String detailsOw, Short grossBase, Double vatWoDpm, Double vatWoDpmFc, Double vatWoDpmSc, String cfopcode, String cstcode, Integer usage, String taxOnly, String wtCalced, Double qtyToShip, Double delivrdQty, Double orderedQty, String cogsOcrCod, Integer ciOppLineN, String cogsAcct, String chgAsmBoMw, Timestamp actDelDate, String ocrCode2, String ocrCode3, String ocrCode4, String ocrCode5, Double taxDistSum, Double taxDistSfc, Double taxDistSsc, String postTax, String excisable, Double assblValue, Integer rg23apart1, Integer rg23apart2, Integer rg23cpart1, Integer rg23cpart2, String cogsOcrCo2, String cogsOcrCo3, String cogsOcrCo4, String cogsOcrCo5, String lnExcised, Integer locCode, Double stockValue, Double gpttlBasPr, String unitMsr2, Double numPerMsr2, String specPrice, String cstfIpi, String cstfPis, String cstfCofins, String exLineNo, String isSrvCall, String UMtdl, Double UMtmd, Double UZc, Double UZz, Double UMjg, Double UGjjg, Double UTsjg, Integer UDjNo, Short UDjNozj, String UCkck, Double UScwc, Double USjzl, String UCzy, Integer UGs, Double UDydj, String URinzz, String USfhh, Double UJgf, String UYdy, Timestamp UDhdate) {
        this.id = id;
