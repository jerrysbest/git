...
/**
 * Oinv entity. @author MyEclipse Persistence Tools
 */

public class Oinv  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5316875589590025102L;
	...
	/** minimal constructor */
    public Oinv(Integer docEntry, Integer docNum, Short instance, Short segment, String pindicator, String docSubType) {
    ...
    /** full constructor */
    public Oinv(Integer docEntry, Integer docNum, String docType, String canceled, String handwrtten, String printed, String docStatus, 
    		String invntSttus, String transfered, String objType, Timestamp docDate, Timestamp docDueDate, String cardCode, 
    		String cardName, String address, String numAtCard, Double vatPercent, Double vatSum, Double vatSumFc, Double discPrcnt,
    		Double discSum, Double discSumFc, String docCur, Double docRate, Double docTotal, Double docTotalFc, Double paidToDate, 
    		Double paidFc, Double grosProfit, Double grosProfFc, String ref1, String ref2, String comments, String jrnlMemo, 
    		Integer transId, Integer receiptNum, Short groupNum, Short docTime, Short slpCode, Short trnspCode, String partSupply, 
    		String confirmed, Short grossBase, Integer importEnt, String createTran, String summryType, String updInvnt, 
    		String updCardBal, Short instance, Integer flags, String invntDirec, Integer cntctCode, String showScn, String fatherCard, 
    		Double sysRate, String curSource, Double vatSumSy, Double discSumSy, Double docTotalSy, Double paidSys, String fatherType, 
    		Double grosProfSy, Timestamp updateDate, String isIct, Timestamp createDate, Double volume, Short volUnit, Double weight, 
    		Short weightUnit, Short series, Timestamp taxDate, String filler, String dataSource, String stampNum, String isCrin, 
    		Integer finncPriod, Short userSign, String selfInv, Double vatPaid, Double vatPaidFc, Double vatPaidSys, Short userSign2, 
    		String wddStatus, Integer draftKey, Double totalExpns, Double totalExpFc, Double totalExpSc, Integer dunnLevel, 
    		String address2, Short logInstanc, String exported, Integer stationId, String indicator, String netProc, Double aqcsTax, 
    		Double aqcsTaxFc, Double aqcsTaxSc, Double cashDiscPr, Double cashDiscnt, Double cashDiscFc, Double cashDiscSc, 
    		String shipToCode, String licTradNum, String paymentRef, Double wtsum, Double wtsumFc, Double wtsumSc, Double roundDif, 
    		Double roundDifFc, Double roundDifSy, String checkDigit, Integer form1099, String box1099, String submitted, String poPrss, 
    		String rounding, String revisionPo, Short segment, Timestamp reqDate, Timestamp cancelDate, String pickStatus, 
    		String pick, String blockDunn, String peyMethod, String payBlock, Integer payBlckRef, String maxDscn, String reserve, 
    		Double max1099, String cntrlBnk, String pickRmrk, String isrcodLine, Double expAppl, Double expApplFc, Double expApplSc, 
    		String project, String deferrTax, String letterNum, Timestamp fromDate, Timestamp toDate, Double wtapplied, 
    		Double wtappliedF, String boeReserev, String agentCode, Double wtappliedS, Double equVatSum, Double equVatSumF, 
    		Double equVatSumS, Short installmnt, String vatfirst, Double nnSbAmnt, Double nnSbAmntSc, Double nbSbAmntFc, 
    		Double exepAmnt, Double exepAmntSc, Double exepAmntFc, Timestamp vatDate, String corrExt, Integer corrInv, 
    		Integer ncorrInv, String ceecflag, Double baseAmnt, Double baseAmntSc, Double baseAmntFc, String ctlAccount, 
    		Integer bplid, String bplname, String vatregNum, String txInvRptNo, Timestamp txInvRptDt, String kvvatcode, 
    		String wtdetails, Integer sumAbsId, Timestamp sumRptDate, String pindicator, String manualNum, String useShpdGd,
    		Double baseVtAt, Double baseVtAtSc, Double baseVtAtFc, Double nnSbVat, Double nnSbVatSc, Double nbSbVatFc,
    		Double exptVat, Double exptVatSc, Double exptVatFc, Double lypmtAt, Double lypmtAtSc, Double lypmtAtFc, 
    		Double expAnSum, Double expAnSys, Double expAnFrgn, String docSubType, String dpmStatus, Double dpmAmnt,
    		Double dpmAmntSc, Double dpmAmntFc, String dpmDrawn, Double dpmPrcnt, Double paidSum, Double paidSumFc, 
    		Double paidSumSc, String folioPref, Integer folioNum, Double dpmAppl, Double dpmApplFc, Double dpmApplSc, 
    		Integer lpgFolioN, String header, String footer, String posted, Integer ownerCode, String bpchCode, Integer bpchCntc, 
    		String payToCode, String isPaytoBnk, String bnkCntry, String bankCode, String bnkAccount, String bnkBranch, String isIns, 
    		String trackNo, String versionNum, Integer langCode, String bpnameOw, String billToOw, String shipToOw, String retInvoice, 
    		Timestamp clsDate, Integer minvNum, Timestamp minvDate, Short seqCode, Integer serial, String seriesStr, String subStr,
    		/*String model, Double taxOnExp, Double taxOnExpFc, Double taxOnExpSc, Double taxOnExAp, Double taxOnExApF, Double taxOnExApS,
    		String lastPmnTyp, Integer lndCstNum, String useCorrVat, String blkCredMmo, String openForLaC, String excised, 
    		Timestamp excRefDate, String excRmvTime, Double srvGpPrcnt, Integer depositNum, String certNum, String dutyStatus, 
    		String autoCrtFlw, Timestamp flwRefDate, String flwRefNum, Integer vatJenum, Double dpmVat, Double dpmVatFc, 
    		Double dpmVatSc, Double dpmAppVat, Double dpmAppVatF, Double dpmAppVatS, String insurOp347, String ignRelDoc,
    		String buildDesc, String residenNum, Integer checker, Integer payee, Integer copyNumber, String ntsapprov, 
    		Short ntswebSite, String ntseTaxNo, String ntsapprNo, String payDuMonth, Short extraMonth, Short extraDays, 
    		Short cdcOffset, String signMsg, String signDigest, String certifNum, Integer keyVersion, String edocGenTyp,
    		Short eseries, String edocNum, Integer edocExpFrm,*/ 
    		String USms, String UYsdxdjlx, Timestamp UDhdate, String UDq) {
        this.docEntry = docEntry;
        this.docNum = docNum;
