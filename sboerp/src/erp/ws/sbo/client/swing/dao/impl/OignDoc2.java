...
import erp.ws.sbo.client.swing.dao.abs.OignAbsDoc1;
...
public class OignDoc2 extends OignAbsDoc1{
	...
	public Integer getfirst() {
		// TODO Auto-generated method stub		
		  ...
		  hql = "SELECT min(a.docNum) from Oign a inner join ign1 b on a.docentry=b.docentry where b.basetype='202'";
          ob = appMain.lt.sqlclob(hql,0,1);
           if(ob==null||ob.length==0)
           {
        	   return 0;
	...
	public Integer getprev(int id) {
		// TODO Auto-generated method stub
		  hql = "SELECT  max(a.docNum)  from Oign a inner join ign1 b on a.docentry=b.docentry where b.basetype='202' and a.docNum<'"+id+"'";
          ob = appMain.lt.sqlclob(hql,0,1);
           if(ob==null||ob.length==0)
           {
           	  return 0;
	...
	public Integer getnext(int id) {
		// TODO Auto-generated method stub
		  hql = "SELECT  a.docNum  from Oign a inner join ign1 b on a.docentry=b.docentry where b.basetype='202' and a.docNum>'"+id+"'";
          ob = appMain.lt.sqlclob(hql,0,1);
          if(ob==null||ob.length==0)
          {
          	  return 0;
	...
	public Integer getlast() {
		// TODO Auto-generated method stub
		  hql = "SELECT max(a.docNum) from Oign a inner join ign1 b on a.docentry=b.docentry where b.basetype='202'";
          ob = appMain.lt.sqlclob(hql,0,1);
          if(ob==null||ob.length==0)
          {
          	  return 0;
		...
		{			
			hql="select a.docNum,a.usersign,c.U_Name,a.docdate from oign a " +
			 ...
			 hql="select 0, b.u_snid,d.docNum,c.itemcode,c.itemname,b.u_Ymd,b.u_mtmd,c.salunitmsr," +
			 	 ...
			 	 "gs=isnull(b.u_gs,0),0,b.unitmsr,b.u_zz,b.quantity,b.u_scwc," +
	...
	@Override
	public void snverification(OignView v) {
		// TODO Auto-generated method stub
