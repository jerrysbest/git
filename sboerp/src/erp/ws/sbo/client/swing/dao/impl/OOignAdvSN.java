...
public class OOignAdvSN implements IAdvSN<OOignView> {
	
	private AboutView av;
	@Override
    public void add(OOignView v,String SN,boolean ifdraft,String objtype,String Direction,boolean ifpasn,int rowid)
    {
    ...
    public boolean verification(OOignView v)
    {
    	//check snstatus
	    ...
	    for(int i=0;i<a.length;i++)
	    {
		 ...
		 {
			 JOptionPane.showMessageDialog(null,"SN一致性检查出错：sn"+a[i].toString()+"长度不正确");	  
			  return false;
		 }
	...
	@Override
	public boolean snverification(OOignView v) {
	...
	@Override
	public boolean bfcverification(OOignView v) {
		// TODO Auto-generated method stub
		return false;
	}
