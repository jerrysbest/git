...
public class Queue {
	    ...
	    private IDocuments[] queArray; // 队列
	...
	//--------------------------------------------------------------
	    public void insert(IDocuments j)    // 进队列
       {
	...
	//--------------------------------------------------------------
	    public IDocuments remove()          // 取得队列的队头元素。
       {
	    	IDocuments temp = queArray[front++]; // 取值和修改队头指针
	...
	//--------------------------------------------------------------
	    public IDocuments peekFront()       // 取得队列的队头元素。该运算与 remove()不同，后者要修改队头元素指针。
	    {
